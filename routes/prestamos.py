...
def create_user(prestamo: schemas.prestamos.PrestamoCreate, db: Session = Depends(get_db)):
...
async def update_prestamo(id: int, prestamo: schemas.prestamos.PrestamoUpdate, db:Session=Depends(get_db)):
